...
const Footer = () => {
  return (<>
    <FootWrapper>
      ...
      <LinkText type="application/pdf" href='https://drive.google.com/file/d/1eDt5lOJ8JIjgNND5nMJkuIGTSubj9rZ5/view?usp=sharing' target='_blank' rel="noopener noreferrer">Resume</LinkText>
    </FootWrapper>
